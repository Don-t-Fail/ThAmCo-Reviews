...
namespace Reviews.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var reviewDbContext = _context.Review.Include(r => r.Purchase);
            return View(await reviewDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PurchaseId,IsVisible,Rating,Content")] Review review)
        {
